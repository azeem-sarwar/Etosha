...
shadowColor: 'black',
      ...
      <View style={{justifyContent:'space-between'}}>
        ...
        <Text style={{marginLeft: 10, marginVertical: 5,fontSize:10}} appearance="hint" >
          {item.FoodName}
        </Text>
        </View>
  ...
  const header=()=>{
    ...
    <FlatList 
     ...
     <View style={{height:150,backgroundColor:"#fff",borderTopLeftRadius:20,borderTopRightRadius:20}}>
     <View style={{flexShrink:1,flexDirection:'row',marginTop:20,marginHorizontal:20,justifyContent:'space-between'}}>
     <Text >10 Selected  Food{"\n"}Items</Text>
     <Text>Total Amount :{"\n"}$90.00</Text>
     </View>
     <Button style={{marginHorizontal:20,height:50,borderRadius:30,marginTop:25,
