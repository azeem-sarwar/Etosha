    ...
    <View style={{flex: 1, borderTopRightRadius: 30}}>
      <DrawerContentScrollView {...props} style={{borderTopRightRadius: 30}}>
        <View style={styles.drawerContent}>
          ...
          <View>
              <Text style={{fontSize: 16}}>Availability Status</Text>
              <Text style={{fontSize: 10}} appearance="hint">Set up availability Status</Text>
          </View>
          ...
          <View>
              ...
              <Text style={{fontSize: 10}} appearance="hint">See the deliveries</Text>
          </View>
